...
// $database = "jashores_myhmsdb";
// $username = "jashores_wp753";
// $password = "#IR%cu(4rx3P";
...
//$con=mysqli_connect("localhost","jashores_wp753","#IR%cu(4rx3P","jashores_myhmsdb");
...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> Jashore Sheba Ltd </h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#">Jashore Sheba Ltd </a>
